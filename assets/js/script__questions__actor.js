...
export let cards_score = document.querySelectorAll('.card__score');
...
export let question_txt = document.getElementById('question__txt');
...
export let questions_art;//Количество вопросов
